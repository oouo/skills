...
description: Fetch GitHub Trending repositories and generate structured daily morning reports or weekly trend summaries. Supports outputting directly to console/chat, or pushing to messaging channels (Feishu, Slack, or webhook URLs).
---

# GitHub Trending Report

Generate technical briefings from GitHub Trending and output them to the console or push them to messaging channels.

## Overview
This skill fetches GitHub Trending repositories (daily/weekly), constructs a high-density technical summary, cleans the content to keep it clear and professional, and outputs it to the console/chat or pushes it to messaging channels.

## When to Use
Use this skill when:
- The user requests a daily morning technical report or weekly trend summary from GitHub.
- The user wants to view the report locally or push it to Feishu, Slack, or other webhook receivers.
...
- **If it does not exist**:
  ...
  2. Ask for `push_channel` (options: `console`, `feishu`, `slack`, etc. Default: `console`).
